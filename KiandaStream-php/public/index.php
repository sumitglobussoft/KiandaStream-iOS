...
if( $_REQUEST['action'] == 'logout' ){
    ...
    header("Location: http://kiandastream.globusapps.com/");
...
<meta property="og:url" content="http://kiandastream.globusapps.com//" />
...
<head>
    ...
    <meta property="og:image" content="http://kiandastream.com//images/kiandaimg.jpg" />
    ...
    <title>KiandaStream - A música que nos une.</title>
 ...
 // <![CDATA[  
    ...
    if (mobile) {  
      //  document.location = "http://mobile.kiandastream.com/";  
       // document.getElementById('themainsite').innerHTML = "<a href='http://mobile.kiandastream.com'>Mobile Site</a>";
    } // ]]>
    </script>
...
<body>
    ...
    <section class="hero mvisible parallax-background top-waypoint parallax-background1" data-type="parallax" data-animate-up="header-hide" data-animate-down="header-hide">
        ...
        <div class="container">
            <div class="hero-inner left">
                <h1 class="big_white">Kiandastream é
    ...
    <section id="home-content" class="top-waypoint" data-animate-up="header-hide" data-animate-down="header-show">
        ...
        <section id="about-us" class="menu-in">
            <header class="section-header">
                ...
                <p class="section-tagline">Kiandastream é uma plataforma musical, que irá disponiblizar aos usuários o acesso à centenas de músicas Angolanas e países vizinhos.</p>
            </header>
            <div id="about-icons">
                <div class="container">
                    <div class="row">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="column four wow fadeInUp" data-wow-delay="1s">
                        ...
                        <p>Crie um perfil com cores e imagens a tua escolha. Segue pessoas com gosto musical parecido ao teu e aproveita todas as novidades que o KiandaStream tem para ti.</p>
                    </div>
                </div>
        ...
        <footer>
            <div id="copyright" class="wow fadeInUp" data-wow-offset="50">
                ...
                <span class="block">Orgulhosamente criado com <i class="fa fa-heart"></i> por Angolanos
                    <br/>Kiandastream Copyright 2014. Todos os direitos reservados.
                    <br/><a href="#">Politicas de Privacidade | Termos e Condicoes</a></span>
            </div>
            <div id="social" class="wow fadeInUp" data-wow-offset="0">
                <ul>
                    <li><a href="http://facebook.com/kiandastream" target="_blank"><i class="fa fa-facebook"></i></a>
                    </li>
                    <li><a href="http://twitter.com/kiandastream" target="_blank"><i class="fa fa-twitter"></i></a>
                    </li>
                    <li><a href="http://instagram.com/kianda_stream" target="_blank"><i class="fa fa-instagram"></i></a>
                    </li>
                    <li><a href="http://kiandastream.com//blog" target="_blank"><i class="fa fa-wordpress"></i></a>
                    </li>
                </ul>
            </div>
        </footer>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyACwNqVNI1v0QdX1JUFGkI9b_NJ7JX84YI&amp;sensor=false"></script>
