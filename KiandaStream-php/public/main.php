	...
	echo <<<HTML
		...
		<script type="text/javascript">
		  <![CDATA[  
		    ...
		    if (mobile) {  
		        document.location = "http://localhost.kiandastream.com/main.php";  
		    }  ]]>
		</script>
		...
		<script type="text/javascript">
		var _urq = _urq || [];
		_urq.push(['initSite', 'a7b49bfc-d60d-477b-aa84-40d8ff26b5f5']);
		(function() {
...
//      $('#current_download_songs1').click(function(evt) {
//      evt.preventDefault();  //stop the browser from following
//     var url = '/static/songs/1000.mp3';
...
//    request.setRequestHeader('X-Try', "blabla");
//     console.log(request);
//    request.setContentType("text/plain"); 
//   request.setHeader("Content-disposition", "attachment;filename="+url);
