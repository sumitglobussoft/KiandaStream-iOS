...
<head>
<meta charset="utf-8">
<title>Kiandastream - Admin Control Panel</title>
...
HTML;
    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">Copyright &copy; 2014 by <a href="http://kiandastream.com" target="_blank">Kiandastream</a></p>
      </div>
    </div>
    </div>
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Sign in &middot; Kiandastream Control Panel</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <!-- Le styles -->
