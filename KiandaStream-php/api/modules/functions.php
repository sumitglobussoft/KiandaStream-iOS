...
function songlist_images( $album_id ){
    ...
    $dir =  realpath(ROOT_DIR."/../public");
	$text = str_replace('\/', '/', $dir);
	
  // echo ($text . "/static/albums/" . $album_id ."_small.jpg");die;
	global $config, $db;
	
	if(file_exists($text ."/static/albums/" . $album_id ."_small.jpg")){
	//echo $dir . "/static/albums/" . $album_id ."_small.jpg";die;
		$image = array(
...
function artist_images( $album_id, $artist_id ){
	global $config, $db;
	$dir =  realpath(ROOT_DIR."/../public");
	if(file_exists($dir . "/static/albums/" . $album_id ."_extralarge.jpg")){
